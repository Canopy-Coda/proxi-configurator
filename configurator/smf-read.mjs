// smf-read.mjs — minimal Standard MIDI File (SMF) reader (the LENS tab's
// FILE mode parses stored takes with it). VENDORED, byte-for-byte, from
// daw-lens/smf.mjs so the configurator deploys self-contained: the published
// site is ONLY /configurator/ + the pedal library, and an import reaching into
// ../daw-lens/ 404s in production (it blanked the app on 2026-07-14). Keep this
// a copy of daw-lens/smf.mjs — test/smf-read.mjs fails CI if the two drift.
//
